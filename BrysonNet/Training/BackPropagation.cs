...
{
    public class BackPropagation : IFeedForwardTraining
    {
        ...
        /// 
        /// </summary>
        /// <param name="learningRate">Learning rate of training.</param>
        /// <param name="precision">Precision</param>
        /// <param name="momentumRate"><para>Momentum is used to prevent from finding local minima.</para>Range: [0, 1].</param>
        public BackPropagation(double learningRate, double precision, double momentumRate)
        {
